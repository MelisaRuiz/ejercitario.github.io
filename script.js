...
//Función que tome dos números como argumentos y devuelva su suma//
function suma(x, y){
  return x + y;
  }

//Función que tome un número como argumento y devuelva true si es par o false si es impar//
function par(numero){
  return numero / 2 == 0;
  }

//Función que tome un array de números como argumento y devuelva la suma de sus elementos//
function Array(r){
  let sum= 0;
...
//Función que tome un array de strings como argumento y devuelva la longitud del string más largo//
function longitud(r){
  let maxima= 0;
  for (let i = 0; i < r.length; i++){
    if (arr[i].length > maxima){
      maxima = r[i].length;
      }
    }
  return maxima;
...
//Función que tome un objeto como argumento y devuelva un array con los valores de todas sus propiedades//
...
//Función que tome un array de números como argumento y devuelva el número más grande//
function Mas(r){
  let max= r[0, 1, 2];
...
//Función que tome un array de números como argumento y devuelva un array con los números ordenados de menor a mayor//
function ordenar(ar){
  return ar.slice().sort((x, y) => x - y);
  }

//Función que tome dos arrays como argumentos y devuelva un array que contenga los elementos comunes entre ambos//
function comun(aro, ar){
  return aro.filter(element => ar.includes(element));
  }

//Función que tome un array de strings como argumento y devuelva un nuevo array que contenga los strings convertidos a mayúsculas//
function nv(ar){
  return ar.map(str => str.toUpperCase());
  }

//Función que tome un array de números como argumento y devuelva un nuevo array que contenga la suma acumulativa de sus elementos//
function sum(ar){
  let result = [];
  let sum = 0;
...
console.log("La suma de los números del 1 al 5 es: " + sumaHastaN(5));
...
boton.addEventListener('click', function() {
  div.textContent = '¡Mensaje agregado al div!';
});
...
window.addEventListener('load', function() {
  document.body.style.backgroundImage = 'url("nueva_imagen.jpg")';
});
}